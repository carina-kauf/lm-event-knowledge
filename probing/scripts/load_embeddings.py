...
dic_models = {'bert-large-cased': BertModel.from_pretrained('bert-large-cased', output_hidden_states=True), 'roberta-large': RobertaModel.from_pretrained('roberta-large', output_hidden_states=True), 'gpt2-xl': GPT2LMHeadModel.from_pretrained('gpt2-xl', output_hidden_states=True)}
