...
def output(model_name, dataset_name):
  ...
  plt.show()
  print(df_out)
  df_out.to_csv('/om2/user/jshe/EventsRev.csv')
output('bert-large-cased', '/om2/user/jshe/lm-event-knowledge/analyses_clean/clean_data/clean_EventsRev_SentenceSet.csv')
