...
```{r}
which_models <- "all_main" #can be "llms_all", "llms_main", "baselines", or "all_main"
...
plot.plaus.density = ggplot()+
  geom_density(data=dat, mapping=aes(NormScore, fill =factor(Plausibility, levels=c("Implausible","Plausible"))), alpha = 0.2)+
