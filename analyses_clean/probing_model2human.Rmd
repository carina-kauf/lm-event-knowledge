...
dat = read.csv(paste(model2human_dir, datafile, sep="/"))
...
savename <- "model2human_all_datasets_ceiled.png"
...
savename <- "model2human_EventsAdapt_active-passive_ceiled.png"
ggsave(paste(savedir,savename,sep="/"), width=20, height=8, units='cm', device='tiff', dpi=700)
```
...
savename <- "model2human_EventsAdapt_AI-AAN_ceiled.png"
ggsave(paste(savedir,savename,sep="/"), width=20, height=8, units='cm', device='tiff', dpi=700)
```