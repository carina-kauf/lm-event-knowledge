...
which_models <- "anns_main" #can be "anns_all", "anns_main", or "all_main"
...
anns_main <- c("GPT2-xl.l2r","BERT-large.pverb","RoBERTa-large.pverb","tinyLSTM.surprisal") 
baselines <- c("syntax.PPMI","thematicFit.prod", "SDM")
