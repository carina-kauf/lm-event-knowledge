...
human <- c("human")
llms_main <- c("RoBERTa-large.sentence-PLL", "BERT-large.sentence-PLL", "deBERTa-xxlarge.sentence-PLL", "GPT-J.sentence-LL", "GPT-2-xl.sentence-LL", "MPT-7b.sentence-LL", "MPT-30b.sentence-LL")
...
# shorten model names
llms_main_short <- c("RoBERTa", "BERT", "deBERTa", "GPT-J", "GPT-2", "MPT-7b", "MPT-30b")
